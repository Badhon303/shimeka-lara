      ...
      <form v-else @submit.prevent="placeOrder" class="checkout-layout">
        ...
        <div class="checkout-main">
          ...
          <div class="checkout-section">
            ...
            <p v-if="cartStore.summary.subtotal >= settings.free_shipping_threshold" class="free-shipping-msg">🎉 Your order qualifies for free shipping!</p>
          </div>
            ...
            <div class="payment-options">
              ...
              <label class="payment-option" :class="{ active: form.payment_method === 'card' }">
                ...
                <div class="payment-info">
                  ...
                  <span class="payment-desc">Secure payment with card</span>
                </div>
              </label>
            </div>
          </div>
...
const computedShipping = computed(() => {
  ...
  if (subtotal >= settings.value.free_shipping_threshold) return 0;
